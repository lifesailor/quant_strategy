...
for(statrun in 1:2){
  ...
  ivol<-as.data.frame(read.csv("data/ivol.csv", row.names=1,header=TRUE))[,colnames(RET)]
...
# write csv
write.csv(functionoutput[[5]], file='C:\\Users\\jungyoon.choi\\Desktop\\jungyoon\\project\\risk_premia\\python\\strategy\\check\\past\\evo.csv')
write.csv(functionoutput[[6]], file='C:\\Users\\jungyoon.choi\\Desktop\\jungyoon\\project\\risk_premia\\python\\strategy\\check\\past\\evo_lag.csv')
