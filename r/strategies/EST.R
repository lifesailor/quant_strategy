...
for(statrun in 1:2){
  ...
  GV<-as.data.frame(read.csv("data/growthvalue.csv", row.names=1,header=TRUE))
...
# write csv
write.csv(functionoutput[[5]], file='C:\\Users\\jungyoon.choi\\Desktop\\jungyoon\\project\\risk_premia\\python\\strategy\\check\\past\\est.csv')
write.csv(functionoutput[[6]], file='C:\\Users\\jungyoon.choi\\Desktop\\jungyoon\\project\\risk_premia\\python\\strategy\\check\\past\\est_lag.csv')
